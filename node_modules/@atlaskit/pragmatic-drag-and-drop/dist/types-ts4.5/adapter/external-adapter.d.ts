import { BaseEventPayload, CleanupFn, DropTargetEventBasePayload, DropTargetEventPayloadMap, DropTargetGetFeedbackArgs, EventPayloadMap, ExternalDragType, MonitorGetFeedbackArgs, NativeMediaType } from '../internal-types';
